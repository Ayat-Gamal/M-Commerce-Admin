...
import com.example.m_commerce_admin.features.home.presentation.component.EnhancedOrdersCard
...
private fun HomeContent(
    orders: List<com.example.m_commerce_admin.features.home.domain.entity.Order>,
    stockLevel: List<com.example.m_commerce_admin.features.inventory.domain.entity.InventoryLevel>?,
    navController: NavController
) {
    LazyColumn(
